...
namespace Core.Extensions
{
    public static class QueryParametersExtensions
    {
        ...
        public static bool IsDynamic(this QueryParameters queryParameters)
        {
            return !String.IsNullOrEmpty(queryParameters.DynamicField) && !String.IsNullOrEmpty(queryParameters.DynamicValue);
        }
